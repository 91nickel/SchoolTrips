...
<body class="events bg2">
  <div class="menu">
    ...
    <a href="events.php" class="el sel">Пожарные в городе</a>
      ...
      <div class="uk-modal-dialog uk-modal-body">
          ...
          <form>
              ...
              <div class="input-block ib-1">
                <span class="in-3">
                  <input style="width: auto;transform: scale(1.3);" type="checkbox" id="offert_ck" name="offert">
                </span>
...
try {
    var yaCounter39632640 = new Ya.Metrika({
        id:39632640,
        clickmap:true,
        trackLinks:true,
