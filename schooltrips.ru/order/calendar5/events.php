...
<body class="events bg2">
  ...
  <div class="p">
    <h3>Карамельная фабрика</h3>
    Для того, чтобы записаться:
    <br><br>1. Выберите мероприятие
    ...
    <br>5. За день до экскурсии до 21:00 вы получите детали с местом встречи и номером куратора
  ...
  <div class="filter">
    <form id="filter">
      ...
      <input class="uk-input" name="childs" type="text" placeholder="Кол-во детей">
      <input class="uk-input" name="adults" type="text" placeholder="Кол-во взрослых">
      <button class="uk-button uk-button-primary">Показать доступные</button>
    </form>
  </div>

  <div class="events main new">
    <div class="block"></div>
  </div>
