...
<html>
<head>
	<title>Список экскурсий от School Trips</title>
					...
					<nav>
						<div class="nav nav-tabs monthes d-flex" id="nav-tab" role="tablist">
							<a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home"
							   role="tab" aria-controls="nav-home" aria-selected="true">Сентябрь</a>
							<a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile"
							   role="tab" aria-controls="nav-profile" aria-selected="false">Октябрь</a>
							<a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact"
							   role="tab" aria-controls="nav-contact" aria-selected="false">Ноябрь</a>
						</div>
					</nav>
							...
							<div class="dates">
								<div class="date d-flex">
									...
									<div class="line d-flex">
										...
										<div class="order"><a href="#" data-toggle="modal" data-target="#modal-pay">Купить</a>
										</div>
									</div>
									<div class="line d-flex">
							...
							<div class="dates">
								...
								<div class="date d-flex">
									...
									<div class="line d-flex">
										...
										<div class="order"><a href="#" data-toggle="modal"
										                      data-target="#order">Купить</a></div>
									</div>
								</div>
							</div>
						</div>
		...
		<div class="container">
			<div class="head-b top-line d-flex align-items-center justify-content-between">
				...
				<div class="top-menu links d-flex justify-content-between">
					<div><a href="/list" class="active">Экскурсии</a></div>
